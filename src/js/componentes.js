            ...
            <nav>
                <ul>
                    <li class='menu-profile-user'>
                        ...
                        <textarea id="welcomeProfile" rows="4" cols="20">${userLogin} </textarea>
            ...
            <div class = 'devsite-post'>
                <div class='newPost'>
                    <select id="typePost" >
                     ...
                     <p type='text' id='input-post' value='En quien estas pensando?'> Hola </p><br>
                     <input type="text" name="postOne"  id="postOne"><br>                    
                    <div id='button-post'>                  
                        <button type="button" id="btnPublicar" value="Publicar">Publicar</button>
                        <input type='button' value='Cancelar'>

                    </div>  
                    <textarea  id="input-post" rows="8" cols="30" name="postTwo" placeholder='Muestra Publicacion '></textarea>                 
                </div >
